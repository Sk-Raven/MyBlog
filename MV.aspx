<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MV.aspx.cs" Inherits="MV" %>
<!DOCTYPE HTML>
<!--
...
<body>
    ...
    <div id="page">
        ...
        <header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(images/2.JPG);" data-stellar-background-ratio="0.5">
                            ...
                            <div class="text-left content-article">
                                <div class="row">
                                    <div class="col-lg-13 cp-r animate-box ">
                                        ...
                                        <a class="h4" href="https://www.bilibili.com/video/av7352536/?from=search&seid=10974107938575293744" style="text-decoration:none">中岛美嘉 曾经我也想过一了百了 live</a>
                                        
                                        <p class="col-sm-pull-0"></p>
                                        <a class="h4" href="Downloadcontroller.aspx?Hotel-California.WAV" style="text-decoration:none">加州旅馆现场版下载</a>
                                </div>
                               </div>
                            </div>
                        </article>
