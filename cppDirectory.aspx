<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cppDirectory.aspx.cs" Inherits="cppDirectory" %>
...
<body>
    ...
    <div id="page">
                        ...
                        <ul>
                            ...
                            <li class="has-dropdown">
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li><a href="#" target="_blank">Youtube视频</a></li>
                                </ul>
                            </li>
                            <li class="has-dropdown">
        ...
        <header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(images/9.png);" data-stellar-background-ratio="0.5">
                    ...
                    <div class="col-md-7 text-left">
                        <div class="display-t">
                            <div class="display-tc animate-box" data-animate-effect="fadeInUp">
                                ...
                                <h1 class="mb30"><a>&nbsp;&nbsp;C++目录</a></h1>
                                <p class="date-post" >&nbsp;&nbsp;&nbsp;编写环境&nbsp;<a target="_blank"href="https://www.jetbrains.com/clion/" class="text-link">CLION</a></p>
                                <p class="date-post">&nbsp;&nbsp;&nbsp;调试环境&nbsp;<a target="_blank"href="http://bloodshed.net/dev/devcpp.html" class="text-link">DEVCPP</a></p>
