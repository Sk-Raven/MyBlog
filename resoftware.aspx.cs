...
public partial class resoftware : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        MySqlCommand cmd = new MySqlCommand("SELECT resoftware.html,resoftware.title,resoftware.download FROM resoftware ORDER BY resoftware.`int` ASC", con);
