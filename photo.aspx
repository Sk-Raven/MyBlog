...
<body>
    ...
    <div id="page">
                        ...
                        <ul>
                            <li class="has-dropdown">
                               <a  style="font-size:17px">编程</a>
                                <ul class="dropdown">
                                    <li><a href="cppDirectory.aspx">C++</a></li>
        ...
        <header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(images/10.png);" data-stellar-background-ratio="0.5">
                                ...
                                <div class="row">
                                    <div class="col-lg-13 cp-r animate-box ">
                                        ...
                                        <img src="images/1.jpg" />
                                             ...
                                             <p>&nbsp;</p>
                                             <h2>杭州</h2>   
                                           <img src="images/photo/hz1.jpg" /> 
                                            <p>&nbsp;</p>
                                            <img src="images/photo/hz2.jpg" /> 
                                            <p>&nbsp;</p>
                                            <img src="images/photo/hz3.jpg" /> 
                                            <p>&nbsp;</p>
                                            <img src="images/photo/hz4.jpg" /> 
                                            <p>&nbsp;</p>
                                            <p>&nbsp;</p>
                                          
                                             <h2>苏州</h2> 
                                             <img src="images/photo/sz1.jpg" /> 
                                            <p>&nbsp;</p>
                                            <img src="images/photo/sz2.jpg" /> 
                                            <p>&nbsp;</p>
                                            <img src="images/photo/sz3.jpg" /> 
                                            <p>&nbsp;</p>
                                            <img src="images/photo/sz4.jpg" /> 
                                           <p>&nbsp;</p>
                                            <p>&nbsp;</p>
                                            <h2>无锡</h2>
                                              <img src="images/photo/wx1.jpg" /> 
                                           <p>&nbsp;</p>
                                            <p>&nbsp;</p>
                                              <h2>学校</h2>
                                             <img src="images/photo/yx1.jpg" /> 
                                            <p>&nbsp;</p>
                                             <img src="images/photo/yx2.jpg" />
                                         <p>&nbsp;</p>
                                            <p>&nbsp;</p>
                                              <h2>扬州</h2>
                                            <img src="images/photo/yz1.jpg" /> 
                                            <p>&nbsp;</p>
                                             <img src="images/photo/yz2.jpg" />
                                </div>
</div>
                                    </div>
                            </div>
                ...
                <div class="row row-pb-md">
                    ...
                    <div class="col-md-4">
                        <div class="post-entry">
                            ...
                            <div class="post-copy">
                                <h4><a href="single.html">抗锯齿技术解析</a></h4>
                                <a class="post-meta"><span class="date-posted">2017.11.10</span></a>
                            </div>
                        </div>
                    </div>
