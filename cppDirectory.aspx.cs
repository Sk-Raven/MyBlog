...
public partial class cppDirectory : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        MySqlCommand cmd = new MySqlCommand("SELECT cpp.html,cpp.title,cpp.download FROM cpp ORDER BY cpp.`int` ASC", con);
