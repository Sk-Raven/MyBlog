...
<body>
    ...
    <div id="page">
        ...
        <header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(images/AA/<%=image%>);" data-stellar-background-ratio="0.5">      
                ...
                <div class="row">
                    <div class="col-md-7 text-left">
                        <div class="display-t">
                                    ...
                                    <h1 class="mb30"><a href="#"><%=title%></a></h1>
                                    <p>by <a href="#" class="text-link"><%=writter%></a></p>
                                </div>
                        </div>
                    </div>
                </div>
