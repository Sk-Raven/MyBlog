...
public partial class life : System.Web.UI.Page
{
  public string directory = null;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        MySqlCommand cmd = new MySqlCommand("SELECT life.html,life.title,life.download FROM life ORDER BY life.`int` ASC", con);
        ...
        while (dr.Read())
        {
            ...
            {
                directory += "<a class=\"h4\"  style=\"text-decoration:none\" href=\"text.aspx?data=life&text=" + num.ToString() + "\">";
                num++;
            }
